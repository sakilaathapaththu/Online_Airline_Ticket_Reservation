...
<ul class="nav">
 ...
 <?php 
    ...
    $weight=$_POST['weight'];
       ...
       $query="UPDATE `users` SET user_name='$user_name',email='$email',phone='$phone',password='$password',firstname='$firstname',lastname='$lastname',age='$age',gender='$gender',marital_status='$marital_status',height='$height',weight='$weight' where id=$id";
      ...
      <form id="Register"  method="POST">
        ...
        <!--last name-->
          ...
          <label for="phone" class="fl fontLabel"> Phone No.: </label>
            ...
            <!--marital status-->
    		<div class="box">
          <label for="marital status" class="fl fontLabel"> marital status: </label>
    			<div class="new iconBox">
            <i class="fa fa-user" aria-hidden="true"></i>
          </div>
    			<div class="fr">
                
    			<input type="text" name="marital_status" class="textBox" placeholder="Enter a marital status" required>
    			</div>
    			<div class="clr"></div>
    		</div>
    		<!--marital status-->
          ...
          <label for="Height" class="fl fontLabel"> Height: </label>
            ...
            <i class="fa fa-user" aria-hidden="true"></i>
    			...
    			<div class="fr">
                <input type="number" name="height" class="textBox" placeholder="Enter a height" required>
          ...
          <label for="Weight" class="fl fontLabel"> Weight: </label>
            ...
            <i class="fa fa-user" aria-hidden="true"></i>
    			...
    			<div class="fr">
                <input type="number" name="weight" class="textBox" placeholder="Enter a weight" required>
