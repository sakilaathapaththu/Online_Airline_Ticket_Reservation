            ...
            <div class="wrapper">
              <div class="left">
                 ...
                 <!-- <button class="btn4">Choise a imge </button>-->
                   ...
                   <p>Gender:- <?php echo $user_data['gender'];?> </p><br>
                   <p>Age:- <?php echo $user_data['age'];?> </p><br>
                   <p>Marital Status:- <?php echo $user_data['marital_status'];?> </p><br>
                   <p>Height:- <?php echo $user_data['height'];?> </p><br>
                   <p>Weight:- <?php echo $user_data['weight'];?> </p><br>
              </div>
              </div>
